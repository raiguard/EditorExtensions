...
infinity_electric_pole.icons = {apply_infinity_tint(extract_icon_info(infinity_electric_pole))}
...
infinity_fuel.icons = {apply_infinity_tint(extract_icon_info(infinity_fuel))}
...
infinity_construction_robot.icons = {apply_infinity_tint(extract_icon_info(infinity_construction_robot))}
...
infinity_logistic_robot.icons = {apply_infinity_tint(extract_icon_info(infinity_logistic_robot))}
...
infinity_cargo_wagon.icons = {apply_infinity_tint(extract_icon_info(infinity_cargo_wagon))}
...
infinity_fluid_wagon.icons = {apply_infinity_tint(extract_icon_info(infinity_fluid_wagon))}
