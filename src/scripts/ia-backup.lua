...
event.gui.on_selection_state_changed('im_ia_mode_dropdown', function(e)
    refresh_ia_gui(util.get_player(e), change_ia_mode_or_priority(util.player_table(e.player_index).ia_gui))
end)

event.gui.on_selection_state_changed('im_ia_priority_dropdown', function(e)
    refresh_ia_gui(util.get_player(e), change_ia_mode_or_priority(util.player_table(e.player_index).ia_gui))
end)

event.gui.on_value_changed('im_ia_slider', function(e)
...
event.gui.on_text_changed('im_ia_slider_textfield', function(e)
    local data = util.player_table(e.player_index).ia_gui
    local entity = data.entity
    local mode = ia_states.mode[data.mode_dropdown.selected_index]
...
event.gui.on_confirmed('im_ia_slider_textfield', function(e)
...
event.gui.on_selection_state_changed('im_ia_slider_dropdown', function(e)
    local data = util.player_table(e.player_index).ia_gui
    local entity = data.entity
    local mode = ia_states.mode[data.mode_dropdown.selected_index]
...
event.register({defines.events.on_player_mined_entity, defines.events.on_robot_mined_entity, defines.events.on_entity_died, defines.events.script_raised_destroy}, function(e)
